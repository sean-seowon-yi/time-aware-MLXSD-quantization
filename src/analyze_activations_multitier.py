"""
Multi-tier (A4/A6/A8) activation quantization analyzer — experimental extension.

NOT a faithful TaQ-DiT reproduction. Preserved for future use when implementing
dynamic per-timestep bit-width switching improvements over the baseline.
Use analyze_activations.py for the W4A8 TaQ-DiT baseline.
"""
